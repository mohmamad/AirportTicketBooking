...
namespace Airport.BLLTests
{
    ...
    public class BookingHandlerTests
    {
        ...
        {
            //--arrange
            string expected = "1,1,100,palestine,china,8/10/2023 12:00:00 AM,telitbees,lala,mohamad,business";
            booking.Update("1,1,100,palestine,china,8/10/2023 12:00:00 AM,telitbees,lala,mohamad,economy", expected);
            //--act
            List<string> actual = booking.ViewAllUserBookings("mohamad");
            //--assert
